...
const AddPlaces = () => {
   ...
   {/*------------------ form data here ------------------------------- */}
                    ...
                    <div className=" shadow-xl w-[900px] h-[700px] mx-auto mt-12 rounded-md  mb-32">
                        ...
                        <div>
                            <input type="email" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10  px-5" placeholder="Enter Email"/>
                        </div>
                        <div>
                            <input type="text" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10  px-5" placeholder="Enter Name" />
                        </div>
                      
                           </div>
                    <div className="flex justify-center items-center gap-4">
                        <div className="">
                            <input type="text" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10 px-5" placeholder="Enter Location" />
                        </div>
                        <div className="">
                            <input type="number" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10  px-5" placeholder="Enter Average_cost" />
                        </div>
                     </div>
                    ...
                    <div className="flex justify-center items-center gap-4">
                        <div className="">
                            <input type="number" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10  px-5" placeholder="Enter TotaVisitorsPerYear" />
                        </div>
                        <div className="">
                            <input type="number" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10  px-5" placeholder="Enter Days " />
                        </div>
                     </div>
                    ...
                    <div className="flex justify-center items-center gap-4">
                        <div className="">
                            <input type="text" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10  px-5" placeholder="Enter Tourists_spot_name" />
                        </div>
                        <div className="">
                            <input type="text" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10 px-5" placeholder="Enter Country Name " />
                        </div>
                     </div>


                    <div className="flex justify-center items-center gap-4 px-10">
                        <select name="" id="" className="px-6 w-1/2 border-b-2 border-[#FB8E26] rounded-xl  h-10 ">
                        ...
                        <div className="">
                            <textarea type="text" className="w-[400px] border-b-2 border-[#FB8E26] rounded-xl  h-10 px-5 py-2" placeholder="Enter Short Desciption " />
                        </div>
                        ...
                        <div className="">
                            <div className=" ">
                                {showName?.name ? (
                                    <div className=" mx-auto flex w-[830px]  items-center gap-x-6   rounded-lg border-2 border-dashed border-[#FB8E26] p-5 bg-white">
                                    ...
                                    <label className=" mx-auto flex w-[830px]  flex-col items-center justify-center space-y-3 rounded-lg border-2 border-dashed border-gray-400 p-6 bg-white" htmlFor="file5">
                        ...
                        <button className="text-md border-[#FB8E26] hover:bg-[#FB8E26] hover:text-white   font-serif font-semibold border-b-2 rounded-xl px-12 py-2">Add Spots</button>
